// app/input/page.tsx（最終形：C対応 + 生成中キャンセル/再試行 + ⑳オンボーディング）
'use client';
      ...
      >
        <div style={{ display: 'grid', gap: 10 }}>
          ...
          <Step
            ...
            desc="良いプロンプトは保存して再利用。/templates から /input に読み込めます"
          />
          <div style={hintStyle}>
            ※右上の「ガイド」からいつでも再表示できます
          </div>
        </div>
      </Modal>
    </main>
...
/** 既存トーンに合わせた軽量モーダル（result/templatesと同系統） */
function Modal({
  open,
  title,
  description,
